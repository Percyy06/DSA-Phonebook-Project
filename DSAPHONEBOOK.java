...
public class DSAPHONEBOOK extends JFrame {

    ArrayList<Contact> phonebook = new ArrayList<>();
    Color backgroundColor = new Color(60, 63, 65); // Dark background
    Color buttonColor = new Color(80, 80, 150); // Blue buttons
    Color textColor = new Color(210, 210, 210); // Light text
    ...
    public DSAPHONEBOOK() {
        ...
        // Button Click Sound
        ActionListener playSound = e -> playSound("resources/selectButtonSound.mp4");
        ...
        insertButton.addActionListener(e -> {
            ...
            JButton submitButton = createStyledButton("Add Contact");
        ...
        searchButton.addActionListener(e -> {
            ...
            JButton searchSubmit = createStyledButton("Search");
        ...
        displayButton.addActionListener(e -> {
            ...
            displayArea.setBackground(new Color(45, 48, 50));
        ...
        deleteButton.addActionListener(e -> {
            ...
            JButton deleteSubmit = createStyledButton("Delete");
        ...
        updateButton.addActionListener(e -> {
            ...
            JButton updateSubmit = createStyledButton("Update");
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            DSAPHONEBOOK mainApp = new DSAPHONEBOOK();
